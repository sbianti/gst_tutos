...
#define TIME_FORMAT "u:%02u:%02u.%02u"
...
int main(int argc, char *argv[]) {
  ...
  /* Originellement, c'était ce stream qui était joué : */
  ...
  data.playbin = gst_element_factory_make("playbin", "Le joueur binaire");
  ...
  do {
	...
	if (!gst_element_query_duration(data.playbin, fmt, &data.duration))
      ...
      /* Not using GST_TIME_FORMAT */
      g_print("Position %" TIME_FORMAT " / %" TIME_FORMAT "\r",
